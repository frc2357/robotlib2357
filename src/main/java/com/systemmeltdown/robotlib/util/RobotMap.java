...
public class RobotMap {
    ...
    public RobotMap(int DRIVE_MAX_RPMS, int ENCODER_TICKS_PER_ROTATION, double DRIVE_STICK_DEADBAND,
            ...
            double DRIVER_TURN_PROPORTION, double DRIVER_SPEED_PROPORTION_SLOW, double DRIVER_TURN_PROPORTION_SLOW,
            double GUNNER_SPEED_PROPORTION, double GUNNER_TURN_PROPORTION, double FAILSAFE_TRIM_FORWARD_DEFAULT,
            double FAILSAFE_TRIM_REVERSE_DEFAULT, double DRIVER_SLOW_TRIGGER_THRESHOLD, int CAN_ID_LEFT_DRIVE,
            int CAN_ID_LEFT_SLAVE, int CAN_ID_RIGHT_DRIVE, int CAN_ID_RIGHT_SLAVE, int CAN_ID_Pigeon_IMU,
            int GYRO_AXIS_TOTAL, int VEL_FEED_FWD, double WHEEL_CIRCUMFERENCE_INCHES, int TALON_TIMEOUT_MS,
            int TALON_PID_PRIMARY, int TALON_SLOT_VELOCITY, int TALON_SLOT_DISTANCE, int TALON_SLOT_TURNING,
            PIDValues PID_DRIVE_POS, PIDValues PID_DRIVE_SPEED, PIDValues PID_DRIVE_YAW, int GYRO_AXIS_YAW,
            double DRIVER_ENCODER_MAX_FORWARD_LIMIT_FACTOR, int DRIVER_ENCODER_MAX_DIFF) {
