...
public class ZipFileOutput extends ThreadLogOutput {
  ...
  public ZipFileOutput(final String dirPath, final String fileName, final Map<String, Object> header, final double timeSecondsRoundingFactor) {
    super();
    m_dirPath = dirPath;
    m_fileName = fileName;
    m_header = header;
  ...
  @Override
  public void run() {
    setLogWriter(new ZipFileLogWriter(m_dirPath, m_fileName, m_header, m_timeSecondsRoundingFactor));
